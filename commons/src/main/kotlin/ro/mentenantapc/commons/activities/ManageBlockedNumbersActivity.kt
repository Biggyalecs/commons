...
import ro.mentenantapc.commons.compose.extensions.onEventValue
import ro.mentenantapc.commons.compose.screens.ManageBlockedNumbersScreen
import ro.mentenantapc.commons.compose.theme.AppThemeSurface
import ro.mentenantapc.commons.dialogs.AddOrEditBlockedNumberAlertDialog
import ro.mentenantapc.commons.dialogs.ExportBlockedNumbersDialog
import ro.mentenantapc.commons.dialogs.FilePickerDialog
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isDialer = remember {
                config.appId.startsWith("org.MentenantaPc.phone")
            }
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("org.MentenantaPc.phone")) {
