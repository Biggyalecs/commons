...
import ro.mentenantapc.commons.asynctasks.CopyMoveTask
...
import ro.mentenantapc.commons.interfaces.CopyMoveListener
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!packageName.startsWith("ro.mentenantapc.", true)) {
            if ((0..50).random() == 10 || baseConfig.appRunCount % 100 == 0) {
                val label = "You are using a fake version of the app. For your own safety download the original one from www.bulk-sms.org. Thanks"
