...
import ro.mentenantapc.commons.extensions.getIntValue
import ro.mentenantapc.commons.extensions.getStringValue
import ro.mentenantapc.commons.models.PhoneNumber
import ro.mentenantapc.commons.models.SimpleContact
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "ro.mentenantapc.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "org.MentenantaPc.phone" && packageName != "org.MentenantaPc.messages" && packageName != "org.MentenantaPc.calendar") {
                return contacts
            }
